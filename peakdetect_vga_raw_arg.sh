...
build/examples/dome/1_dome_input_and_output.bin --dome_mode 1 --model_pose $modelPose --display -1 --num_gpu -1 --num_gpu_start 0 --rawDir $rawMainPath --write_txt $mainPath/$savePath --scale_number 3 --scale_gap 0.15 --frame_first $frameStart --frame_last $frameEnd --panel_start 1 --panel_end 20 --cam_sampleNum $camSamplingNum
