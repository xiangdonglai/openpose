...
#build/examples/dome/1_dome_input_and_output.bin --rawDir $rawMainPath --num_gpu 1 --logtostderr --write_txt $mainPath/$savePath --output_resolution 640x480 --num_scales 3 --scale_gap 0.15 --frame_first $frameStart --frame_last $frameEnd --panel_start 3 --panel_end 4 --num_gpu_start 3 --cam_sampleNum $camSamplingNum


# #build/examples/dome/1_dome_input_and_output.bin --rawDir $rawMainPath --num_gpu 1 --logtostderr --write_txt $mainPath/$savePath --output_resolution 640x480 --num_scales 3 --scale_gap 0.15 --frame_first $frameStart --frame_last $frameEnd --num_gpu_start 3 --panel_start 1 --panel_end 20 --cam_sampleNum $camSamplingNum
